...
const NewsLatterBox = () => {
  ...
  return (
    <div
      className="wow fadeInUp shadow-three dark:bg-dark relative z-10 rounded-sm bg-white p-8 sm:p-11 lg:p-8 xl:p-11"
      data-wow-delay=".2s"
    >
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Join our newsletter for tips & tricks to help your customer care team increase their productivity
      </p>
      <div>
        <input
          type="text"
          ...
          className="border-stroke dark:text-body-color-dark dark:shadow-two mb-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none focus:border-primary dark:border-transparent dark:bg-veryBlack dark:focus:border-primary dark:focus:shadow-none"
        />
        <input
          type="email"
          name="email"
        ...
        <span className="absolute left-2 top-7">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#268F3E" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
